...
export const nativeColors = {
  dark: {
    ...
    'foreground.3': '#82807C',
    link: '#F6F4F1',
    border: 'rgba(255, 255, 255, 0.08)', 'border.on.background': '#525252', 'border.on.surface.1': '#545453', 'border.on.surface.2': '#565655', 'border.on.surface.3': '#585857',
    backdrop: 'rgba(0, 0, 0, 0.6)', 'backdrop.on.background': '#080706', 'backdrop.on.surface.1': '#0D0C0B', 'backdrop.on.surface.2': '#12110F', 'backdrop.on.surface.3': '#161514',
    'border.strong': '#858381',
    inverse: '#F6F4F1',
    'inverse.foreground': '#151312',
    ring: '#719DC4',
    'status.ok': '#49AB79',
    'status.warn': '#D58D25',
    'status.bad': '#FEAAAC',
  ...
  light: {
    ...
    backdrop: 'rgba(0, 0, 0, 0.4)', 'backdrop.on.background': '#C9C9C7', 'backdrop.on.surface.1': '#CBCBCB', 'backdrop.on.surface.2': '#C5C4C2', 'backdrop.on.surface.3': '#BFBEBC',
  ...
  'fuka.dark': {
    ...
    'foreground.3': '#7B8186',
    link: '#EFF6FB',
    border: 'rgba(255, 255, 255, 0.08)', 'border.on.background': '#525253', 'border.on.surface.1': '#535455', 'border.on.surface.2': '#555657', 'border.on.surface.3': '#575859',
    backdrop: 'rgba(0, 0, 0, 0.6)', 'backdrop.on.background': '#050709', 'backdrop.on.surface.1': '#0A0D0E', 'backdrop.on.surface.2': '#0F1113', 'backdrop.on.surface.3': '#131517',
    'border.strong': '#7F8488',
    inverse: '#EFF6FB',
    'inverse.foreground': '#111417',
    ring: '#719DC4',
    'status.ok': '#49AB79',
    'status.warn': '#D58D25',
    'status.bad': '#FEAAAC',
  ...
  'fuka.light': {
    ...
    'foreground.3': '#858C90',
    link: '#111619',
    border: 'rgba(0, 0, 0, 0.08)', 'border.on.background': '#F0F3F6', 'border.on.surface.1': '#F6F6F6', 'border.on.surface.2': '#E8EEF2', 'border.on.surface.3': '#E1E7EB',
    backdrop: 'rgba(0, 0, 0, 0.4)', 'backdrop.on.background': '#C6C9CB', 'backdrop.on.surface.1': '#CBCBCB', 'backdrop.on.surface.2': '#C0C5C8', 'backdrop.on.surface.3': '#BABFC2',
    'border.strong': '#7B8084',
    inverse: '#111619',
    'inverse.foreground': '#F9FCFF',
    ring: '#426D95',
    'status.ok': '#307450',
    'status.warn': '#905B06',
    'status.bad': '#7C000C',
  ...
  'yama.dark': {
    ...
    'foreground.3': '#867E7C',
    link: '#FBF2EF',
    border: 'rgba(255, 255, 255, 0.08)', 'border.on.background': '#535252', 'border.on.surface.1': '#555453', 'border.on.surface.2': '#575655', 'border.on.surface.3': '#595757',
    backdrop: 'rgba(0, 0, 0, 0.6)', 'backdrop.on.background': '#090606', 'backdrop.on.surface.1': '#0E0B0A', 'backdrop.on.surface.2': '#13100F', 'backdrop.on.surface.3': '#171413',
    'border.strong': '#888280',
    inverse: '#FBF2EF',
    'inverse.foreground': '#171311',
    ring: '#719DC4',
    'status.ok': '#49AB79',
    'status.warn': '#D58D25',
    'status.bad': '#FEAAAC',
  ...
  'yama.light': {
    ...
    'foreground.3': '#908986',
    link: '#191312',
    border: 'rgba(0, 0, 0, 0.08)', 'border.on.background': '#F6F2F0', 'border.on.surface.1': '#F6F6F6', 'border.on.surface.2': '#F2EBE9', 'border.on.surface.3': '#EBE4E2',
    backdrop: 'rgba(0, 0, 0, 0.4)', 'backdrop.on.background': '#CBC8C7', 'backdrop.on.surface.1': '#CBCBCB', 'backdrop.on.surface.2': '#C8C3C1', 'backdrop.on.surface.3': '#C2BDBB',
    'border.strong': '#847E7C',
    inverse: '#191312',
    'inverse.foreground': '#FFFBF9',
    ring: '#426D95',
    'status.ok': '#307450',
    'status.warn': '#905B06',
    'status.bad': '#7C000C',
  ...
  'aota.dark': {
    ...
    'foreground.3': '#7E817B',
    link: '#F2F6EF',
    border: 'rgba(255, 255, 255, 0.08)', 'border.on.background': '#525252', 'border.on.surface.1': '#545453', 'border.on.surface.2': '#555655', 'border.on.surface.3': '#575857',
    backdrop: 'rgba(0, 0, 0, 0.6)', 'backdrop.on.background': '#060806', 'backdrop.on.surface.1': '#0B0D0A', 'backdrop.on.surface.2': '#10110F', 'backdrop.on.surface.3': '#141613',
    'border.strong': '#81847F',
    inverse: '#F2F6EF',
    'inverse.foreground': '#131511',
    ring: '#719DC4',
    'status.ok': '#49AB79',
    'status.warn': '#D58D25',
    'status.bad': '#FEAAAC',
  ...
  'aota.light': {
    ...
    'foreground.3': '#898C86',
    link: '#131611',
    border: 'rgba(0, 0, 0, 0.08)', 'border.on.background': '#F1F3EF', 'border.on.surface.1': '#F6F6F6', 'border.on.surface.2': '#EBEEE9', 'border.on.surface.3': '#E4E7E2',
    backdrop: 'rgba(0, 0, 0, 0.4)', 'backdrop.on.background': '#C8C9C6', 'backdrop.on.surface.1': '#CBCBCB', 'backdrop.on.surface.2': '#C2C5C0', 'backdrop.on.surface.3': '#BDBFBA',
    'border.strong': '#7E817C',
    inverse: '#131611',
    'inverse.foreground': '#FAFDF8',
    ring: '#426D95',
    'status.ok': '#307450',
    'status.warn': '#905B06',
    'status.bad': '#7C000C',
