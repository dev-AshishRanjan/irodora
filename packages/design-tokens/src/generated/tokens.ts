...
export const COLOR = {
  dark: {
    ...
    'border.strong': { srgb: 'rgba(255, 255, 255, 0.14)', oklch: { l: 1, c: 0, h: 0, alpha: 0.14 }, usage: 'nonText' },
    ...
    'status.ok': { srgb: '#75B992', oklch: { l: 0.73, c: 0.09, h: 158 }, usage: 'text' },
    'status.warn': { srgb: '#E9A44E', oklch: { l: 0.77, c: 0.13, h: 70 }, usage: 'text' },
    'status.bad': { srgb: '#D4665E', oklch: { l: 0.64, c: 0.14, h: 26 }, usage: 'text' },
  ...
  light: {
    ...
    'border.strong': { srgb: 'rgba(0, 0, 0, 0.15)', oklch: { l: 0, c: 0, h: 0, alpha: 0.15 }, usage: 'nonText' },
