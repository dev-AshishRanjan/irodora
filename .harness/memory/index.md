...
- [effects/the-warm-cool-rule-is-written-twice-because-an-install-cannot-run.md](effects/the-warm-cool-rule-is-written-twice-because-an-install-cannot-run.md) — **E-032** · one colour rule, two implementations, RESOLVED by F-099; and the blocker it recorded had already been closed by F-098.
