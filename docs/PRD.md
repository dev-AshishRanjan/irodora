...
| OQ-29 | The serif: no mockup names it. Of the 20 serifs installed where it was measured, 01's wordmark and tagline match Georgia Pro best (0.825) — a face under a commercial licence. F-275 then measured 20 SIL OFL faces the same way (R9-MOCKUP-FIDELITY §5): **Source Serif 4 Medium** (0.747) and **Gelasio SemiBold** (0.732 — Gelasio is metric-compatible with Georgia) are closest on 01, while **Charis SIL** leads 00 (0.762) and 14 (0.793) ahead of every installed face and sits 31st on 01. No open face reaches Georgia Pro on 01; three come within 0.08–0.10. On 25, the only caps wordmark, the whole field is low and Georgia Pro ranks 83rd, so either that image is drawn in another face or caps at that size separate nothing. Ship Georgia Pro under its licence, or one of the open faces — and if so, which? | R9 |
