...
| OQ-37 | Four icons are drawn in colours that conflict C10 does not list: 00's colour-wheel and palette icon buttons (a hue ring and a painter's palette, in full colour), 13's colour-harmony score icon (three overlapping red, green and blue circles) and 11's gap bulb (a yellow bulb, drawn like an emoji). C10 already declares the other tinted glyphs — 02's gold HUD, 04 and 12's green verdicts, 27's tan state art. The icon set (F-228) draws every glyph in one ink. Should these four carry their drawn colours as further C10 exceptions, or be drawn in ink? | R9 |
