...
| IRO-ED-004 | Irodora editorial curation — seed combinations, 2026 | editorial | Irodora | Proprietary — Irodora original work | 2026-09-08 | The four seed combinations in `content/combinations/` (F-196): small sets of 2026.08.1 entries chosen to go together, one per intent. Every member is an entry we published ourselves; no combination dataset was read, and none could be — the reference is A Dictionary of Color Combinations and every accessible digitisation of it embeds a digitiser's choices about printing, paper ageing and illuminant, which ARE the dataset (ADR-0007, content/AGENTS.md §2). Each derivation states the OKLCh reason the members were put together. One editor, self-reviewed (ADR-0060) |
| IRO-ED-005 | Irodora editorial curation — seasonal summary, 2026 | editorial | Irodora | Proprietary — Irodora original work | 2026-09-15 | The seasonal-summary rule in `content/rules/` (F-223, ADR-0102): how a profile's temperature, lightness and chroma ranges are classified, and which season and characteristic each combination is summarised as. Boundaries cite boundaries the product already states (the phrase lexicon's measured gaps; a temperature gap between reachable values), and every cell carries its reason. A convention, not a measurement. Japanese words written, NOT reviewed by a competent speaker (ADR-0060, OQ-5). One editor, self-reviewed (ADR-0060) |
