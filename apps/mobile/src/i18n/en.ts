...
export const en = {
  ...
  'home.what1': 'What colour is this.',
  'home.what2': 'What goes with it.',
  'home.what3': 'Whether it suits you.',
  'home.onDevice': 'All of it on your phone. Nothing is sent anywhere.',
  ...
  'lens.quality.fair': 'Fair',
  'lens.quality.poor': 'Poor',
  'lens.light': 'Light',
  'lens.space': 'Colour space',
  'lens.next': 'To improve it',
  ...
  // THE SEASONAL SUMMARY (F-223, ADR-0102). A summary of the ranges beside it, in the mockup's
  // order — season, then its dominant characteristic. One key per pair rather than two words
  // composed at render: the catalogue has no interpolation, and each language orders a pair its
  // own way. Never a sentence about the person: no "you are".
  'profile.season.spring.light': 'Spring Light',
  'profile.season.spring.deep': 'Spring Deep',
  'profile.season.spring.bright': 'Spring Bright',
  'profile.season.spring.muted': 'Spring Muted',
  'profile.season.spring.warm': 'Spring Warm',
  'profile.season.spring.cool': 'Spring Cool',
  'profile.season.summer.light': 'Summer Light',
  'profile.season.summer.deep': 'Summer Deep',
  'profile.season.summer.bright': 'Summer Bright',
  'profile.season.summer.muted': 'Summer Muted',
  'profile.season.summer.warm': 'Summer Warm',
  'profile.season.summer.cool': 'Summer Cool',
  'profile.season.autumn.light': 'Autumn Light',
  'profile.season.autumn.deep': 'Autumn Deep',
  'profile.season.autumn.bright': 'Autumn Bright',
  'profile.season.autumn.muted': 'Autumn Muted',
  'profile.season.autumn.warm': 'Autumn Warm',
  'profile.season.autumn.cool': 'Autumn Cool',
  'profile.season.winter.light': 'Winter Light',
  'profile.season.winter.deep': 'Winter Deep',
  'profile.season.winter.bright': 'Winter Bright',
  'profile.season.winter.muted': 'Winter Muted',
  'profile.season.winter.warm': 'Winter Warm',
  'profile.season.winter.cool': 'Winter Cool',
  'profile.keep': 'Keep',
