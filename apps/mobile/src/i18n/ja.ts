...
export const ja: Record<MessageKey, string> = {
  ...
  'home.what2': '何と合うか。',
  'home.what3': '自分に似合うか。',
  'home.onDevice': 'すべてこの端末の中で。どこにも送られません。',
  'home.lastReading': '最後の読み取り',
  'home.noReadings': 'まだ読み取りがありません',
  ...
  'separation.severityLabel': '模擬の強さ',
  'separation.severity': 'Machado の表は11段階です。その間の値は補間しています。',
  'atlas.corpus': '収録版',
  'atlas.colours': '色',
  'atlas.palettes': '配色',
  ...
  'lens.capture': 'この色を読む',
  'lens.capturing': '読み取り中…',
  'lens.captureFailed':
    '読み取れませんでした。カメラから映像が届いていません。もう一度お試しください。',
  'lens.mode.still': 'タップして読む',
  'lens.mode.live': 'ライブ',
  'lens.mode.stillHint': 'タップするまで読み取りは行いません。映像を表示しているだけです。',
  'lens.mode.liveHint':
  ...
  'lens.quality.fair': 'ふつう',
  'lens.quality.poor': '悪い',
  'lens.light': '光',
  'lens.space': '色空間',
  'lens.next': '改善するには',
  ...
  // 季節のまとめ (F-223, ADR-0102). Katakana transliterations of the English ids, in the mockup's
  // order with a nakaguro — kept apart from 春夏秋冬, which the corpus uses for a colour's season.
  // NOT reviewed by a competent speaker (OQ-5's standing gap; F-223's attested criterion).
  'profile.season.spring.light': 'スプリング・ライト',
  'profile.season.spring.deep': 'スプリング・ディープ',
  'profile.season.spring.bright': 'スプリング・ブライト',
  'profile.season.spring.muted': 'スプリング・ミュート',
  'profile.season.spring.warm': 'スプリング・ウォーム',
  'profile.season.spring.cool': 'スプリング・クール',
  'profile.season.summer.light': 'サマー・ライト',
  'profile.season.summer.deep': 'サマー・ディープ',
  'profile.season.summer.bright': 'サマー・ブライト',
  'profile.season.summer.muted': 'サマー・ミュート',
  'profile.season.summer.warm': 'サマー・ウォーム',
  'profile.season.summer.cool': 'サマー・クール',
  'profile.season.autumn.light': 'オータム・ライト',
  'profile.season.autumn.deep': 'オータム・ディープ',
  'profile.season.autumn.bright': 'オータム・ブライト',
  'profile.season.autumn.muted': 'オータム・ミュート',
  'profile.season.autumn.warm': 'オータム・ウォーム',
  'profile.season.autumn.cool': 'オータム・クール',
  'profile.season.winter.light': 'ウィンター・ライト',
  'profile.season.winter.deep': 'ウィンター・ディープ',
  'profile.season.winter.bright': 'ウィンター・ブライト',
  'profile.season.winter.muted': 'ウィンター・ミュート',
  'profile.season.winter.warm': 'ウィンター・ウォーム',
  'profile.season.winter.cool': 'ウィンター・クール',
  'profile.keep': 'のこす',
  'profile.drop': 'はずす',
  ...
  'combos.what':
    'この色から生成した関係です。色の並び方であって、何を着るべきかという助言ではありません。',
  'combos.generated': '生成',
  'combos.open': 'この色に合う色',
  'combos.cost': '画面に収めるための移動量',
  'combos.exact': 'ここにある色はすべて、この画面がそのまま表示できます。',
  'combos.more': 'ほかの関係',
  'combo.warm-cool': '暖色と寒色',
  'combo.analogous': '隣り合う色',
  'combo.complementary': '正反対の色',
  'combo.split': '正反対の両隣',
  'combo.triadic': '三等分',
  'combo.tetradic': '四等分',
  'combo.monochromatic': '明暗',
  'combo.tonal': '薄めた色',
  'combo.neutral': '灰みへ',
  ...
  'browse.coverage': '組み合わせの状況',
  'browse.coverageNote':
    'このビルドのスコアしきい値で数えています。組み合わせの数であり、良し悪しの判断ではありません。',
  'browse.coverageUnit': '着',
  'browse.band.none': '組み合わせなし',
  'browse.band.few': '1〜3通りの組み合わせ',
  'browse.band.some': '4〜9通りの組み合わせ',
  'browse.band.many': '10〜24通りの組み合わせ',
  'browse.band.most': '25通り以上の組み合わせ',
  'browse.gaps': '最も増えるのは',
  'browse.gapsNote':
    'いずれもその領域の中心の色から推定した数値で、お持ちの服を測ったものではありません。',
  'browse.gapsUnit': '通りの追加',
  'browse.coverageOne': '1着ではまだ組み合わせができません。2着目を追加すると表示されます。',
  'browse.count': '服の数',
  'browse.editing': '編集中',
