...
/**
 * The Wardrobe tab's own stack (F-145). It holds adding a garment, the Outfit Lab, and the shopping check.
 *
 ...
 */
export default function WardrobeLayout(): React.JSX.Element {
